...
![Диаграмма usecases](./uc0-activity-auth-legacy.png)
...
![Диаграмма активности UC-2](./uc2-activity.png).
...
### Диаграмма активности UC-4

![Диаграмма активности UC-4](./uc4-activity.png)

_(Рисунок X — Диаграмма активности сценария "Просмотр статистики и прогресса")_

### Диаграмма процесса UC-4 (BPMN)

![Диаграмма процесса UC-4](./uc4-bpmn.png)

_(Рисунок X — BPMN-процесс сценария "Просмотр статистики и прогресса")_
