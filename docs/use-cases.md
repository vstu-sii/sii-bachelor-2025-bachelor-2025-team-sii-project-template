...
Предусловие:
1) Пользователь (HR-менеджер) авторизован в системе;
...
8.	Система возвращает экран с вопросами по каждому кандидату.
...
2. Вакансия без резюме\
Описание: в ATS нет кандидатов по вакансии.\
Реакция системы: система предлагает либо загрузить внешние резюме, либо активировать поиск по базе рекомендаций.\
Ценность: гибкость в работе с вакансиями, даже если кандидатов ещё нет.
...
![Flow Diagram](docs/uml_diagram.png)
