...
![Flow Diagram](uml_diagram_full2.png)
...
1. Система парсит, создает критерии на основе требоний вакансии и сохраняет требования вакансии
...
- EH3: Нечитаемый документ → система предлагает альтернативные способы загрузки (другой формат)
...
- AF2: Пользователь выбирает тип вопросов (технические/поведенческие/кейсовые)
