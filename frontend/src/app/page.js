      ...
      <div className="w-full max-w-4xl space-y-10">
        ...
        <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
          ...
          <p className="text-xs text-slate-400">
            ...
            endpoint <code className="text-sky-400">/ai/generate</code> вернёт список простых карточек.
          </p>
        ...
        <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
          <h2 className="text-xl font-semibold">
            2. Управление колодами (UC-1 / UC-2)
          </h2>

          <p className="text-xs text-slate-400">
            Здесь реализован простой CRUD через endpoint{" "}
            <code className="text-sky-400">/decks</code>: создание и просмотр колод в памяти.
          </p>
